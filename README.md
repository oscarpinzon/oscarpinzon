...
## What I’m working on
- **Shipping:** small, production-ready examples that mirror real job tasks (CI/CD, deploys, APIs).
- **Learning:** modern React patterns, .NET minimal APIs, CI/CD best practices.

## Selected projects
- **Accessible Combobox (React/TS)** — component with Storybook, tests, and CI setup. Shows component design, testing, and library ergonomics.  
